...
<style>
  ...
  *{{box-sizing:border-box;margin:0;padding:0}}
  body{{font-family:-apple-system,BlinkMacSystemFont,"PingFang SC","Microsoft YaHei",sans-serif;
    background:var(--bg);color:var(--txt);line-height:1.6;padding:24px;max-width:none;margin:0 auto}}
  ...
  td{{padding:11px 10px;border-bottom:1px solid #f0f0ec;vertical-align:middle}}
